...
Algoritmo Integrador
		Definir genMatriz, muestra como cadena;
		Definir varDimension como entero;
		Escribir 'Ingrese su mustra:';
		leer muestra;
		
		validacion(muestra,varDimension);
...
SubProceso verificacionDiagonalPrincipal(Matriz,varDimension)
